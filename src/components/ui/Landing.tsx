...
const Landing = () => {
  ...
  const Albums: IAlbum[] = [
    ...
    { nombre: "Use Your Ilussion I", año: 1991, coverImagen: "/assets/img/albums/uyi.webp", linkSpotify: "https://open.spotify.com/intl-es/album/0CxPbTRARqKUYighiEY9Sz", duracion:"76 minutos ", sello:"Geffen Records",
      canciones: [
        { "nombre": "Right Next Door to Hell", "id": 1, "spotySong": "https://open.spotify.com/intl-es/track/5YXvG4PL4Wisyx2ScUxVFF", "duracion": "3:02" },  //Para el buen TS, poner las props entre comillas o no le es indiferente, "nombre": y nombre: son identicos. Las comillas son obligatorias cuando el valor que le pasas a las props tiene espacios, como por ejemplo: "nombre": "Juan Zapata"
