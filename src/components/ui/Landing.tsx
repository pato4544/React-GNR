...
const Landing = () => {
  ...
  const Vinilos: IVinilos[] = [
    ...
    { titulo: "Use Your Ilussion I Dorado", precio: "$44999 ARS", descripcion:"", productoImagen: "/assets/img/tienda/vinilos/uyi1-vinilo.png", listaImagen: [
      {imagen:""},
    ] },
    ...
    { titulo: "Apettite For Destruction Dorado", precio: "$54999 ARS", descripcion:"", productoImagen: "/assets/img/tienda/vinilos/appetite-vinilo.png", listaImagen: [
      {imagen:""},
    ] },
