...
const Vinilo:FC<IVinilos> = ({productoImagen, titulo, precio, descripcion, detalles, tipo, listaImagen}) => {

  const navigate = useNavigate();
const irProducto = () => {
  const vinilo = {titulo, precio, descripcion, productoImagen, detalles, tipo, listaImagen}  
