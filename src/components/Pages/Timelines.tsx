...
const Timelines = () => {
  ...
  return (
    <div className="bg-black min-h-screen w-full pt-12">
        ...
        <div className='flex flex-col text-white pb-20 pr-32 pl-32 text-center h-[600px] bg-gradient-to-tr from-black via-yellow-600 to-black'>
          <h1 className='font-bebasneue text-white text-center pb-12  pt-12 text-[55px] space-x-6'>Timeline</h1>
