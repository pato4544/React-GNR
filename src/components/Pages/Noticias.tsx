...
const Notice = () => {
  ...
  const listaNoticias: INoticias[] = [
    ...
    {titulo: "¡Singapur! ¡No podemos esperar!", fecha: "07.19.22", contenido: "", imagenNoticia: "/assets/img/new5.webp"},
    {titulo: "¡Bangkok, volvemos para una noche increíble!", fecha: "07.18.22", contenido: "gika", imagenNoticia: "/assets/img/new6.webp"},
    {titulo: "¡GUNS N' ROSES LLEGA A JAPÓN EN 2022!", fecha: "06.22.22", contenido: "", imagenNoticia: "/assets/img/new7.webp"},
    {titulo: "¡GUNS N' ROSES VUELVE A MÉXICO! ", fecha: "06.14.22", contenido: "", imagenNoticia: "/assets/img/new8.webp"},
    {titulo: "¡Más shows de GN'R anunciados para Sudamérica!", fecha: "04.07.22", contenido: "gika", imagenNoticia: "/assets/img/new9.webp"}
]
