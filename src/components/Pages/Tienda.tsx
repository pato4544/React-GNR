...
const Tienda = () => {
  ...
  return (
    <div className="min-h-screen bg-[linear-gradient(90deg,rgba(0,0,0,1)_0%,rgba(190,178,35,1)_100%)] ;">
      ...
      <div className="pt-20">
      <h1 className='text-white text-center items-center font-bebasneue text-[55px] space-x-6'>VINILOS</h1>
      ...
      <div className="mt-20 ">
      <h1 className='text-white text-center  items-center font-bebasneue text-[55px] space-x-6'>ROPA</h1>
      ...
      <AnimatePresence mode="wait"/>
      <motion.div key={ropaPage} className="flex gap-6" initial={{ opacity: 0, x: 100 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: -100 }} transition={{ duration: 1 }}>
      ...
      <h1 className='text-white text-center items-center font-bebasneue text-[55px] space-x-6'>ACCESORIOS</h1>
      <div className="flex justify-center gap-4 pt-10">
      ...
      <AnimatePresence mode="wait"/>
      <motion.div key={accesorioPage} className="flex gap-6" initial={{ opacity: 0, x: 100 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: -100 }} transition={{ duration: 1 }}>
