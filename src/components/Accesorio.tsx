...
const Accesorio:FC<IAccesorios> = ({titulo, precio, productoImagen, listaImagen, detalles, descripcion}) => {


  const navigate = useNavigate();
  const irProducto = () => {
    const accesorio = {titulo, precio, productoImagen, listaImagen, detalles, descripcion}
